...
let strings = new LocalizedStrings({
    ...
    es: {
      ...
      errorStudentId: "El estudiante {number} debe tener un número de identificación proporcionado",
    ...
    fr:{
      ...
      errorsOkay: "D'accord",
      errorApptTime: "Vous devez sélectionner une date et une heure de rendez-vous",
      ...
      errorStudentId: "L'élève {numéro} doit avoir un numéro d'identification fourni",
