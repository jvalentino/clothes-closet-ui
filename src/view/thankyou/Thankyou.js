...
class Thankyou extends Component {
    ...
    render() {
      ...
      return (
        <div>
          <Banner />
          <div className="standard-view" style={{'textAlign':AppState.getTextAlign()}}>
            <h1>{strings.formatString(strings.thankYou, {datetime: inputUtil.prettyDateTimeFromIso(body.datetime)})}</h1>
